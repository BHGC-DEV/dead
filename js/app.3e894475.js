(function () {
	...
	var t = {
			1120: function (t, n, r) {
				...
				var o = r(7139);
				const s = t => ((0, a.dD)('data-v-e2b74c56'), t = t(), (0, a.Cn)(), t), c = { class: 'hello' }, u = s(() => (0, a._)('h1', null, 'These birds have been rescued from being bound eternally to the blockchain as NFTs. They now fly free, safe in the Sanctuary.', -1)), l = { class: 'card-group' }, f = {
						class: 'card',
						style: {
							width: '25rem',
							'margin-left': '50px',
